...
## 🇺🇸 English
Practical exercises to master Python syntax, data handling, and programming logic.
...
Tip: Always use () with methods (e.g., .isalpha()) to execute the function, otherwise Python will only show the memory 
location.
